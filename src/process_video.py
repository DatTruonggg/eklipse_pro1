...
class VideoProcessor:
    ...
    def _generate_unique_filename(self, extension):
        ...
        return os.path.join(self.temp_dir, f"{uuid.uuid4()}.{extension}")
    ...
    def download_youtube_video(self):
        ...
        try:
            ...
            log.info(f"Video downloaded successfully: {self.video_path}")
    ...
    def process_uploaded_file(self, uploaded_file):
        ...
        unique_filename = self._generate_unique_filename(Path(uploaded_file.name).suffix.lstrip('.'))
    ...
    def extract_frames(self, interval=1):
        ...
        try: 
            ...
            while cap.isOpened():
                ...
                # Select middle frame for each interval
